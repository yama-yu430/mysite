...
![altテキスト](/config/images/articles/22.png)
![altテキスト](/config/images/articles/23.png)

## 4-3 IntelliJでファイルを作成する(課題作成)

`Java/src`で右クリックし、New/Fileをクリックする。
![altテキスト](/config/images/articles/17.png)

ファイル名を記入する。
![altテキスト](/config/images/articles/18.png)

「Add」をクリックするとファイルが作成されます。
![altテキスト](/config/images/articles/19.png)

## 4-4 IntelliJで作成したソースの動作確認

`Java/src`で右クリックし、「Mark Directory as」をクリックし、「Sources Root」をクリックすると作成したソースにrun(再生マーク)のアイコンが表示されます。
![altテキスト](/config/images/articles/20.png)

Runのマークをクリックすることでソースの処理を確認することが出来ます。
![altテキスト](/config/images/articles/21.png)
...
![altテキスト](/config/images/articles/24.png)

windowsでは左上のメニュー(4本線のアイコン)を選択し、「Git」をクリック、「Push」を選択する。

![altテキスト](/config/images/articles/25.png)

この画面で余計なファイルが入ってないか確認し、Pushをクリックで提出完了です。

![altテキスト](/config/images/articles/26.png)
